...
if /i "%1"=="update" (
    echo openclaw is managed by Item ClawX ^(bundled version^).
    echo.
    echo To update openclaw, update Item ClawX:
    echo   Open Item ClawX ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=Item ClawX
"%~dp0..\..\Item ClawX.exe" "%~dp0..\openclaw\openclaw.mjs" %*
